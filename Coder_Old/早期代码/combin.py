...
#<---------------------角色---------------------------------->
type_right = False  #
while not type_right:

	user_charater = input('Please choose your character(W/M/H):').upper()   #增加玩家选择职业的功能
...
while player.not_dead() and enemy.not_dead(): 
	...
	user_input = input('Choose your action A/B/D (Attack/Attack twice/Defence):').upper() 

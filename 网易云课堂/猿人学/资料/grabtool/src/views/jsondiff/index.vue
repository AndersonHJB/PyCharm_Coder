  ...
  <d2-container>
    ...
    <div id="main">
      <div class="header">
        ...
        <div class="weak">
          <p>
            Validate, format, and compare two JSON documents. See the differences between the objects instead of just
            the new lines and mixed up properties.
          </p>
      ...
      <div class="initContainer">
        <div class="left">
          <textarea spellcheck="false" id="textarealeft" v-model="left_json"
                    placeholder="Enter JSON to compare, enter an URL to JSON"></textarea>
          <pre id="errorLeft" class="error"></pre>
          <span class="fileInput">or <input type="file" id="fileLeft"
                                            onchange="jdd.handleFiles(this.files, 'left')"></span>
        </div>

        <div class="center">
          <button id="compare" v-on:click="compare()">Compare</button>
          <div class="throbber-loader"></div>
          <br/><br/><br/><br/>
          or try some <a href="#" v-on:click="loadSampleData">sample data</a>

        </div>

        <div class="right">
          <textarea spellcheck="false" class="right" id="textarearight" v-model="right_json"
                    placeholder="Enter JSON to compare, enter an URL to JSON"></textarea>

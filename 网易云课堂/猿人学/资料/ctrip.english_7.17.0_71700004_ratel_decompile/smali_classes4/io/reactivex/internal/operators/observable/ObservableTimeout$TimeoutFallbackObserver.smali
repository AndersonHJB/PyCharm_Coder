...
# direct methods
.method public constructor <init>(Lh/a/x;Lh/a/d/i;Lh/a/v;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Lh/a/x;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->itemTimeoutIndicator:Lh/a/d/i;
    ...
    .line 5
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:Lh/a/v;
...
.method public onComplete()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Lh/a/x;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->itemTimeoutIndicator:Lh/a/d/i;
    ...
    invoke-direct {v0, v5, v6, p0}, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutConsumer;-><init>(JLh/a/e/e/d/T;)V
...
.method public onTimeout(J)V
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:Lh/a/v;

    const/4 p2, 0x0

    .line 4
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:Lh/a/v;

    .line 5
    new-instance p2, Lh/a/e/e/d/U;

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Lh/a/x;

    invoke-direct {p2, v0, p0}, Lh/a/e/e/d/U;-><init>(Lh/a/x;Ljava/util/concurrent/atomic/AtomicReference;)V

    invoke-interface {p1, p2}, Lh/a/v;->subscribe(Lh/a/x;)V
...
.method public onTimeoutError(JLjava/lang/Throwable;)V
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Lh/a/x;

    invoke-interface {p1, p3}, Lh/a/x;->onError(Ljava/lang/Throwable;)V
...
.method public startFirstTimeout(Lh/a/v;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, v2, p0}, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutConsumer;-><init>(JLh/a/e/e/d/T;)V

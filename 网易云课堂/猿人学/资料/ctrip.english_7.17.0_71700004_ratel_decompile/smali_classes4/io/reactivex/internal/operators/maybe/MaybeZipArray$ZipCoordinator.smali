...
# direct methods
.method public constructor <init>(Lh/a/n;ILh/a/d/i;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:Lh/a/n;

    .line 3
    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->zipper:Lh/a/d/i;
...
.method public innerComplete(I)V
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:Lh/a/n;
...
.method public innerError(Ljava/lang/Throwable;I)V
    ...
    .line 3
    iget-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:Lh/a/n;

    invoke-interface {p2, p1}, Lh/a/n;->onError(Ljava/lang/Throwable;)V
...
.method public innerSuccess(Ljava/lang/Object;I)V
    ...
    .line 3
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->zipper:Lh/a/d/i;

    iget-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->values:[Ljava/lang/Object;

    invoke-interface {p1, p2}, Lh/a/d/i;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p2, p1}, Lh/a/n;->onSuccess(Ljava/lang/Object;)V

.class public Lcom/ctrip/ibu/tripsearch/module/cmpc/TripSearchCallee;
...
.method public a(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/Object;
    ...
    const-string v0, "91ad5fcd53a44e6716a91401fe3dd4fc"
...
.method public a(Ljava/lang/String;Ljava/util/Map;Le/h/e/j/b/f;)V
    ...
    :cond_0
    const-string v0, "TripSearchCallee - callAsync - "
    ...
    const-string v0, "SearchBoxDynamicContent"
    ...
    const-string p1, "be001bb1bc790867f901d31014a4df9f"
    ...
    .line 4
    new-instance p2, Le/h/e/C/d/h/a;

    invoke-direct {p2, p3}, Le/h/e/C/d/h/a;-><init>(Le/h/e/j/b/f;)V

    invoke-static {v5, p1, p2}, Le/h/e/j/d/l/a/h;->a(IILe/h/e/j/d/l/a/b;)Lh/a/b/b;

    goto :goto_0

    .line 5
    :cond_2
    invoke-interface {p3, v0}, Le/h/e/j/b/f;->onResult(Ljava/lang/Object;)V

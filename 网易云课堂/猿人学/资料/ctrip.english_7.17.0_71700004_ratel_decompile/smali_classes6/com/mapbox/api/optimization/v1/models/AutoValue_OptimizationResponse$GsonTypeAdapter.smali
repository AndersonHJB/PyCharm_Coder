...
.method public constructor <init>(Lcom/google/gson/Gson;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
...
# virtual methods
.method public a(Le/k/c/d/c;Lcom/mapbox/api/optimization/v1/models/OptimizationResponse;)V
    .locals 6
    ...
    .line 6
    :cond_1
    iget-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->a:Le/k/c/l;

    if-nez v0, :cond_2

    .line 7
    iget-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
    ...
    iput-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->a:Le/k/c/l;
    ...
    .line 12
    :cond_3
    iget-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->b:Le/k/c/l;
    ...
    iput-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->b:Le/k/c/l;
    ...
    .line 18
    :cond_5
    iget-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->c:Le/k/c/l;
    ...
    iput-object v0, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->c:Le/k/c/l;
...
.method public read(Le/k/c/d/b;)Lcom/mapbox/api/optimization/v1/models/OptimizationResponse;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_2
    const-string/jumbo v5, "waypoints"
    ...
    .line 11
    :cond_6
    iget-object v1, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->c:Le/k/c/l;

    if-nez v1, :cond_7

    .line 12
    iget-object v1, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
    ...
    invoke-virtual {v1, v3}, Lcom/google/gson/Gson;->a(Le/k/c/c/a;)Le/k/c/l;

    move-result-object v1

    iput-object v1, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->c:Le/k/c/l;
    ...
    .line 17
    :cond_a
    iget-object v2, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->a:Le/k/c/l;

    if-nez v2, :cond_b

    .line 18
    iget-object v2, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
    ...
    iput-object v2, p0, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->a:Le/k/c/l;
...
.method public bridge synthetic read(Le/k/c/d/b;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->read(Le/k/c/d/b;)Lcom/mapbox/api/optimization/v1/models/OptimizationResponse;
...
.method public bridge synthetic write(Le/k/c/d/c;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/mapbox/api/optimization/v1/models/AutoValue_OptimizationResponse$GsonTypeAdapter;->a(Le/k/c/d/c;Lcom/mapbox/api/optimization/v1/models/OptimizationResponse;)V

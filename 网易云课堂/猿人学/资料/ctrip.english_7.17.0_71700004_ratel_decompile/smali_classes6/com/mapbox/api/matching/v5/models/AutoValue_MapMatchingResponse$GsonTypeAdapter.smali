...
.method public constructor <init>(Lcom/google/gson/Gson;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
...
# virtual methods
.method public a(Le/k/c/d/c;Lcom/mapbox/api/matching/v5/models/MapMatchingResponse;)V
    .locals 6
    ...
    .line 6
    :cond_1
    iget-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->a:Le/k/c/l;

    if-nez v0, :cond_2

    .line 7
    iget-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
    ...
    iput-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->a:Le/k/c/l;
    ...
    .line 18
    :cond_5
    iget-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->b:Le/k/c/l;
    ...
    iput-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->b:Le/k/c/l;
    ...
    :goto_2
    const-string/jumbo v0, "tracepoints"
    ...
    .line 24
    :cond_7
    iget-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->c:Le/k/c/l;
    ...
    iput-object v0, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->c:Le/k/c/l;
...
.method public read(Le/k/c/d/b;)Lcom/mapbox/api/matching/v5/models/MapMatchingResponse;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :sswitch_0
    const-string/jumbo v6, "tracepoints"
    ...
    .line 11
    :cond_3
    iget-object v3, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->c:Le/k/c/l;

    if-nez v3, :cond_4

    .line 12
    iget-object v3, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;

    const-class v4, Ljava/util/List;

    new-array v5, v10, [Ljava/lang/reflect/Type;

    const-class v6, Lcom/mapbox/api/matching/v5/models/MapMatchingTracepoint;
    ...
    invoke-virtual {v3, v4}, Lcom/google/gson/Gson;->a(Le/k/c/c/a;)Le/k/c/l;

    move-result-object v3

    iput-object v3, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->c:Le/k/c/l;
    ...
    .line 14
    :cond_5
    iget-object v1, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->b:Le/k/c/l;

    if-nez v1, :cond_6

    .line 15
    iget-object v1, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;

    const-class v4, Ljava/util/List;

    new-array v5, v10, [Ljava/lang/reflect/Type;

    const-class v6, Lcom/mapbox/api/matching/v5/models/MapMatchingMatching;
    ...
    iput-object v1, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->b:Le/k/c/l;
    ...
    .line 20
    :cond_9
    iget-object v2, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->a:Le/k/c/l;

    if-nez v2, :cond_a

    .line 21
    iget-object v2, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->d:Lcom/google/gson/Gson;
    ...
    iput-object v2, p0, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->a:Le/k/c/l;
    ...
    invoke-direct {p1, v2, v0, v1, v3}, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
...
.method public bridge synthetic read(Le/k/c/d/b;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->read(Le/k/c/d/b;)Lcom/mapbox/api/matching/v5/models/MapMatchingResponse;
...
.method public bridge synthetic write(Le/k/c/d/c;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/mapbox/api/matching/v5/models/AutoValue_MapMatchingResponse$GsonTypeAdapter;->a(Le/k/c/d/c;Lcom/mapbox/api/matching/v5/models/MapMatchingResponse;)V

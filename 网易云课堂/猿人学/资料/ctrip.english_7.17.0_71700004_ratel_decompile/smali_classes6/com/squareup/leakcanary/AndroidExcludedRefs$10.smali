.class public final enum Lcom/squareup/leakcanary/AndroidExcludedRefs$10;
...
.method public add(Lcom/squareup/leakcanary/ExcludedRefs$Builder;)V
    ...
    const-string v0, "android.widget.SpellChecker$1"
    ...
    const-string v0, "SpellChecker holds on to a detached view that points to a destroyed activity. mSpellRunnable is being enqueued, and that callback should be removed when  closeSession() is called. Maybe closeSession() wasn\'t called, or maybe it was  called after the view was detached."

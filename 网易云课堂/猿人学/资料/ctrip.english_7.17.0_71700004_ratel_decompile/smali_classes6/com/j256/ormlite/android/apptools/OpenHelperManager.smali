...
# static fields
.field public static final HELPER_CLASS_RESOURCE_NAME:Ljava/lang/String; = "open_helper_classname"

.field public static volatile helper:Lcom/j256/ormlite/android/apptools/OrmLiteSqliteOpenHelper;

.field public static helperClass:Ljava/lang/Class;
...
.field public static wasClosed:Z
...
.method public static constructHelper(Landroid/content/Context;Ljava/lang/Class;)Lcom/j256/ormlite/android/apptools/OrmLiteSqliteOpenHelper;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "Could not construct instance of helper class "
    ...
    const-string v1, "Could not find public constructor that has a single (Context) argument for helper class "
...
.method public static innerSetHelperClass(Ljava/lang/Class;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "Helper class was "
...
.method public static loadHelper(Landroid/content/Context;Ljava/lang/Class;)Lcom/j256/ormlite/android/apptools/OrmLiteSqliteOpenHelper;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static lookupHelperClass(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Class;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "Could not create helper instance for class "
    ...
    const-string v0, "Could not find OpenHelperClass because none of the generic parameters of class "

    const-string v1, " extends OrmLiteSqliteOpenHelper.  You should use getHelper(Context, Class) instead."

...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/Runnable;Lctrip/android/pkg/PackageDownloadListener;)V
    ...
    .line 1
    iput-object p1, p0, Lf/a/v/w;->b:Ljava/lang/String;

    iput-object p2, p0, Lf/a/v/w;->c:Ljava/lang/Runnable;

    iput-object p3, p0, Lf/a/v/w;->d:Lctrip/android/pkg/PackageDownloadListener;
...
.method public onPackageDownloadCallback(Lctrip/android/pkg/PackageModel;Lctrip/android/pkg/Error;)V
    ...
    const-string v0, "24bef7cc5e2c0a510ed9cc65df42aa3a"
    ...
    new-instance v1, Lf/a/v/v;

    invoke-direct {v1, p0, p2, p1}, Lf/a/v/v;-><init>(Lf/a/v/w;Lctrip/android/pkg/Error;Lctrip/android/pkg/PackageModel;)V

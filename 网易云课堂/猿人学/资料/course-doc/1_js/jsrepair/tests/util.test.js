...
const expression = util.expression;
...
const staticCall = expression('String.fromCharCode(32, 97, 46, 34, 39)');
const deepArray = expression(CODE_DEEP_ARRAY);
const deepDict = expression(CODE_DEEP_DICT);
const regexp = expression(CODE_REGEX);


describe('util functions', function() {
  it('should recoginize static literals', function(done) {

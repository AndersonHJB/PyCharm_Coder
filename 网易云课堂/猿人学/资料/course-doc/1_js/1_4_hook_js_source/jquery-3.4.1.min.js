...
eHook.hookBefore(window,'eval',function(method,args){
	console.log("eval function: "+ args[0]);
});


eHook.hookBefore(window,'Function',function(method,args){
	console.log("new function: "+ args[0]);
});
